...
class BlueCoordinates : public Coordinates
{
protected:
	...
	static const BlueCoordinates *instance;

public:
	BlueCoordinates(void);

    static inline const BlueCoordinates * const GetInstance(void)
    {
        return instance;
    }
...
const BlueCoordinates *BlueCoordinates::instance = new BlueCoordinates();

BlueCoordinates::BlueCoordinates(void)
{
	/*
	 ...
	 * Start Zone
	 */
	this->_cr_sz.position.x = 0.357614;
